...
namespace Kata.Spec
{
    ...
    public class when_user_input_is_one_number
    {
        ...
        Because of = () => { _result = _systemUnderTest.Add("8"); };

        It should_return_zero = () => { _result.Should().Be(8); };
        static Calculator _systemUnderTest;
        static int _result;
    }
    ...
    public class when_adding_unknown_amount_of_numbers
    {
        Establish _context = () =>
        {
            _systemUnderTest = new Calculator();
        ...
        It should_return_the_sum_of_those_two_numbers = () => { _result.Should().Be(6); };
        static Calculator _systemUnderTest;
        static int _result;
    }
